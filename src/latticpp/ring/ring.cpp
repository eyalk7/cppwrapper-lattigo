...
namespace latticpp {
    ...
    void copyPolySingleLevel(const Poly sourcePoly, uint64_t sourceIndex,
        ...
        lattigo_copyPolySingleLevel(sourcePoly.getRawHandle(), sourceIndex, targetPoly.getRawHandle(), targetIndex);
    }
    ...
    void invNTTLvl(RingQP ringQP, int levelQ, int levelP, PolyQP pIn, PolyQP pOut) {
        lattigo_invNTTLvl(ringQP.getRawHandle(), levelQ, levelP, pIn.getRawHandle(), pOut.getRawHandle());
    }

    void nTTLvl(RingQP ringQP, int levelQ, int levelP, PolyQP pIn, PolyQP pOut) {
        lattigo_nTTLvl(ringQP.getRawHandle(), levelQ, levelP, pIn.getRawHandle(), pOut.getRawHandle());
    }
