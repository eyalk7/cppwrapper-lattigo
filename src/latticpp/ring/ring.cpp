...
namespace latticpp
{
  ...
  {
    lattigo_ringAdd(ring.getRawHandle(), p1.getRawHandle(), p2.getRawHandle(), p3.getRawHandle());
  }
  ...
  {
    return UniformSampler(lattigo_newUniformSampler(prng.getRawHandle(), ring.getRawHandle()));
  }
