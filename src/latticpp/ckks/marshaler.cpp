...
// void marshalBinaryBootstrapParameters(const BootstrappingParameters
// &btp_params, std::ostream &stream) {
...
// unmarshalBinaryBootstrapParameters(std::istream &stream) {
//   vector<char> buffer(istreambuf_iterator<char>{stream}, {});
//   return BootstrappingParameters(
//       lattigo_unmarshalBinaryBootstrapParameters(buffer.data(),
//       buffer.size()));
// }
